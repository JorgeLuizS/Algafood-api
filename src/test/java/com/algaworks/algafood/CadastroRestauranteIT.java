...
class CadastroRestauranteIT {
    ...
    private String jsonRestauranteComFreteNegativo;
    ...
    void setUp() {
        ...
        jsonRestauranteComFreteNegativo = ResourceUtils.getContentFromResource(
                "/json/incorreto/restaurante-new-york-barbecue-com-frete-negativo.json");
    ...
    @Test
    void deveRetorarStatus400_QuandoCadatrarRestauranteComFreteNegativo() {
    	given()
        .body(jsonRestauranteComFreteNegativo)
        .contentType(ContentType.JSON)
        .accept(ContentType.JSON)
    .when()
        .post()
