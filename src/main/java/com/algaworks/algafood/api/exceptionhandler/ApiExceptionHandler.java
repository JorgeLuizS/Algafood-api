...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex,
		...
		if(ex instanceof UnrecognizedPropertyException) {
			detail = "A propriedade '%s' não existe, ".formatted(path);
			
			
		}else if(ex instanceof IgnoredPropertyException) {
			detail = "A propriedade '%s' existe, mas está sendo ignorada neste formato de entrada.".formatted(path);
			
		}
		
		
		detail += "\nPor favor corrija o formato desta requisição e tente novamente.";
	...
	private ResponseEntity<Object> handleInvalidFormat(InvalidFormatException ex,
		...
		Problem problem = createProblemBuilder(status, problemType, detail)
				.userMessage("""
                        Houve um erro na formatação dos dados digitados.\
                        Verifque a digitação e tente novamente.\
                        """)
				.build();
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
		...
		String detail = "O recurso '%s' que você tentou acessar não existe".formatted(ex.getRequestURL());
