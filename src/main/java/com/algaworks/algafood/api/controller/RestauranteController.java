...
public class RestauranteController {
	...
	/* PARA REFERÊNCIA - 13.1. Fazendo projeção de recursos com @JsonView do Jackson
	 * 
	 * @GetMapping public MappingJacksonValue listar(@RequestParam(required = false)
	 * String projecao){ List<Restaurante>restaurantes =
	 * restauranteRepository.findAll(); List<RestauranteModel>restauranteModel =
	 ...
	 * @JsonView(RestauranteView.Resumo.class)
	 * 
	 * @GetMapping(params = "projecao=resumo") public
...
//				
//				Object novoValor = ReflectionUtils.getField(field, restauranteOrigem);	//novoValor apresenta o valor convertido para o tipo correto do atributo da classe.
//				
...
//			throw new HttpMessageNotReadableException(rootCause.getMessage(), rootCause, serverHttpRequest);
//		}
//	}
